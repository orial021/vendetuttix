...
class Product(Model):
    ...
    init_promotional_date = fields.DatetimeField(auto_now_add=True, null=True)
    end_promotional_date = fields.DatetimeField(auto_now_add=True, null=True)
    ...
    imagen_url = fields.CharField(max_length=50)
